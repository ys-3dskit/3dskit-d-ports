...
enum MBEDTLS_AES_ENCRYPT = 1; /**< AES encryption. */
enum MBEDTLS_AES_DECRYPT = 0; /**< AES decryption. */

/* Error codes in range 0x0020-0x0022 */
/** Invalid key length. */
enum MBEDTLS_ERR_AES_INVALID_KEY_LENGTH = -0x0020;
/** Invalid data input length. */
enum MBEDTLS_ERR_AES_INVALID_INPUT_LENGTH = -0x0022;

/* Error codes in range 0x0021-0x0025 */
/** Invalid input data. */
enum MBEDTLS_ERR_AES_BAD_INPUT_DATA = -0x0021;

/* MBEDTLS_ERR_AES_FEATURE_UNAVAILABLE is deprecated and should not be used. */
/** Feature not available. For example, an unsupported AES key size. */
enum MBEDTLS_ERR_AES_FEATURE_UNAVAILABLE = -0x0023;

/* MBEDTLS_ERR_AES_HW_ACCEL_FAILED is deprecated and should not be used. */
/** AES hardware accelerator failed. */
enum MBEDTLS_ERR_AES_HW_ACCEL_FAILED = -0x0025;
...
struct mbedtls_aes_context
{
    ...
    uint* rk; /*!< AES round keys. */
    uint[68] buf; /*!< Unaligned data buffer. This buffer can
...
int mbedtls_aes_crypt_ctr (
    ...
    size_t length,
    size_t* nc_off,
    ref ubyte[16] nonce_counter,
    ref ubyte[16] stream_block,
    const(ubyte)* input,
    ubyte* output);
