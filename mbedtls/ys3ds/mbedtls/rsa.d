...
enum MBEDTLS_ERR_RSA_BAD_INPUT_DATA = -0x4080;
/** Input data contains invalid padding and is rejected. */
enum MBEDTLS_ERR_RSA_INVALID_PADDING = -0x4100;
/** Something failed during generation of a key. */
enum MBEDTLS_ERR_RSA_KEY_GEN_FAILED = -0x4180;
/** Key failed to pass the validity check of the library. */
enum MBEDTLS_ERR_RSA_KEY_CHECK_FAILED = -0x4200;
/** The public key operation failed. */
enum MBEDTLS_ERR_RSA_PUBLIC_FAILED = -0x4280;
/** The private key operation failed. */
enum MBEDTLS_ERR_RSA_PRIVATE_FAILED = -0x4300;
/** The PKCS#1 verification failed. */
enum MBEDTLS_ERR_RSA_VERIFY_FAILED = -0x4380;
/** The output buffer for decryption is not large enough. */
enum MBEDTLS_ERR_RSA_OUTPUT_TOO_LARGE = -0x4400;
/** The random generator failed to generate non-zeros. */
enum MBEDTLS_ERR_RSA_RNG_FAILED = -0x4480;
...
enum MBEDTLS_ERR_RSA_UNSUPPORTED_OPERATION = -0x4500;

/* MBEDTLS_ERR_RSA_HW_ACCEL_FAILED is deprecated and should not be used. */
/** RSA hardware accelerator failed. */
enum MBEDTLS_ERR_RSA_HW_ACCEL_FAILED = -0x4580;

/*
 * RSA constants
 */
enum MBEDTLS_RSA_PUBLIC = 0; /**< Request private key operation. */
enum MBEDTLS_RSA_PRIVATE = 1; /**< Request public key operation. */

enum MBEDTLS_RSA_PKCS_V15 = 0; /**< Use PKCS#1 v1.5 encoding. */
enum MBEDTLS_RSA_PKCS_V21 = 1; /**< Use PKCS#1 v2.1 encoding. */

enum MBEDTLS_RSA_SIGN = 1; /**< Identifier for RSA signature operations. */
enum MBEDTLS_RSA_CRYPT = 2; /**< Identifier for RSA encryption and decryption operations. */

enum MBEDTLS_RSA_SALT_LEN_ANY = -1;
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
int mbedtls_rsa_check_pub_priv (
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
int mbedtls_rsa_rsassa_pss_sign_ext (
    mbedtls_rsa_context* ctx,
    int function (void*, ubyte*, size_t) f_rng,
    void* p_rng,
    mbedtls_md_type_t md_alg,
