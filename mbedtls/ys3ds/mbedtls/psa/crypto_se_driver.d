module ys3ds.mbedtls.psa.crypto_se_driver;
 ...
 */
alias psa_drv_se_init_t = int function (
 ...
 * is driver-dependent. */
alias psa_key_slot_number_t = c_ulong;
/* __DOXYGEN_ONLY__ || !MBEDTLS_PSA_CRYPTO_SE_C */
 ...
 *          Success.
 */
alias psa_drv_se_mac_setup_t = int function (
    psa_drv_se_context_t* drv_context,
    void* op_context,
 ...
 */
alias psa_drv_se_mac_update_t = int function (
    void* op_context,
    const(ubyte)* p_input,
    size_t input_length);
 ...
 *          Success.
 */
alias psa_drv_se_mac_finish_t = int function (
    void* op_context,
    ubyte* p_mac,
    size_t mac_size,
    size_t* p_mac_length);
 ...
 */
alias psa_drv_se_mac_finish_verify_t = int function (
    void* op_context,
    const(ubyte)* p_mac,
    size_t mac_length);
 ...
 */
alias psa_drv_se_mac_abort_t = int function (void* op_context);
 ...
 *         Success.
 */
alias psa_drv_se_mac_generate_t = int function (
    psa_drv_se_context_t* drv_context,
    const(ubyte)* p_input,
    size_t input_length,
    psa_key_slot_number_t key_slot,
 ...
 *         not match the provided MAC
 */
alias psa_drv_se_mac_verify_t = int function (
    psa_drv_se_context_t* drv_context,
    const(ubyte)* p_input,
    size_t input_length,
    psa_key_slot_number_t key_slot,
 ...
 */
alias psa_drv_se_cipher_setup_t = int function (
    psa_drv_se_context_t* drv_context,
    void* op_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t algorithm,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_cipher_set_iv_t = int function (
    void* op_context,
    const(ubyte)* p_iv,
    size_t iv_length);
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_cipher_update_t = int function (
    void* op_context,
    const(ubyte)* p_input,
    size_t input_size,
    ubyte* p_output,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_cipher_finish_t = int function (
    void* op_context,
    ubyte* p_output,
    size_t output_size,
    size_t* p_output_length);
 ...
 *                              previously started cipher operation
 */
alias psa_drv_se_cipher_abort_t = int function (void* op_context);
 ...
 * \retval #PSA_ERROR_NOT_SUPPORTED \emptydescription
 */
alias psa_drv_se_cipher_ecb_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t algorithm,
    psa_encrypt_or_decrypt_t direction,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_asymmetric_sign_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t alg,
    const(ubyte)* p_hash,
 ...
 */
alias psa_drv_se_asymmetric_verify_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t alg,
    const(ubyte)* p_hash,
    size_t hash_length,
    const(ubyte)* p_signature,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_asymmetric_encrypt_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t alg,
    const(ubyte)* p_input,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_asymmetric_decrypt_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t alg,
    const(ubyte)* p_input,
 ...
 *         Success.
 */
alias psa_drv_se_aead_encrypt_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t algorithm,
    const(ubyte)* p_nonce,
    size_t nonce_length,
    const(ubyte)* p_additional_data,
    size_t additional_data_length,
    const(ubyte)* p_plaintext,
 ...
 *         Success.
 */
alias psa_drv_se_aead_decrypt_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    psa_algorithm_t algorithm,
    const(ubyte)* p_nonce,
...
{
    PSA_KEY_CREATION_IMPORT = 0, /**< During psa_import_key() */
    PSA_KEY_CREATION_GENERATE = 1, /**< During psa_generate_key() */
    PSA_KEY_CREATION_DERIVE = 2, /**< During psa_key_derivation_output_key() */
    PSA_KEY_CREATION_COPY = 3, /**< During psa_copy_key() */
 ...
 */
alias psa_drv_se_allocate_key_t = int function (
    psa_drv_se_context_t* drv_context,
    void* persistent_data,
 ...
 */
alias psa_drv_se_validate_slot_number_t = int function (
    psa_drv_se_context_t* drv_context,
    void* persistent_data,
    const(psa_key_attributes_t)* attributes,
    psa_key_creation_method_t method,
 ...
 *         Success.
 */
alias psa_drv_se_import_key_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    const(psa_key_attributes_t)* attributes,
    const(ubyte)* data,
 ...
 */
alias psa_drv_se_destroy_key_t = int function (
    psa_drv_se_context_t* drv_context,
    void* persistent_data,
    psa_key_slot_number_t key_slot);
 ...
 */
alias psa_drv_se_export_key_t = int function (
    psa_drv_se_context_t* drv_context,
 ...
 */
alias psa_drv_se_generate_key_t = int function (
    psa_drv_se_context_t* drv_context,
    psa_key_slot_number_t key_slot,
    const(psa_key_attributes_t)* attributes,
    ubyte* pubkey,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_key_derivation_setup_t = int function (
    psa_drv_se_context_t* drv_context,
    void* op_context,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_key_derivation_collateral_t = int function (
    void* op_context,
    uint collateral_id,
    const(ubyte)* p_collateral,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_key_derivation_derive_t = int function (
    void* op_context,
 ...
 * \retval #PSA_SUCCESS \emptydescription
 */
alias psa_drv_se_key_derivation_export_t = int function (
    void* op_context,
    ubyte* p_output,
    size_t output_size,
    size_t* p_output_length);
 ...
 */
/* 0.0.0 patchlevel 5 */
enum PSA_DRV_SE_HAL_VERSION = 0x00000005;
