module ys3ds.mbedtls.psa.crypto;
...
public import ys3ds.mbedtls.psa.crypto_platform;
 ...
 */
enum PSA_CRYPTO_API_VERSION_MAJOR = 1;

/**
 * The minor version of this implementation of the PSA Crypto API
 */
enum PSA_CRYPTO_API_VERSION_MINOR = 0;
...
alias psa_hash_operation_t = psa_hash_operation_s;
 ...
 * make any assumptions about the content of this structure except
 * as directed by the documentation of a specific implementation. */
alias psa_mac_operation_t = psa_mac_operation_s;
 ...
 * make any assumptions about the content of this structure except
 * as directed by the documentation of a specific implementation. */
alias psa_cipher_operation_t = psa_cipher_operation_s;
 ...
 * make any assumptions about the content of this structure except
 * as directed by the documentation of a specific implementation. */
alias psa_aead_operation_t = psa_aead_operation_s;
 ...
 * as directed by the documentation of a specific implementation.
 */
alias psa_key_derivation_operation_t = psa_key_derivation_s;
 ...
 * algorithm.
 */
enum PSA_KEY_DERIVATION_UNLIMITED_CAPACITY = cast(size_t) -1;
 ...
 *         results in this error code.
 */
psa_status_t psa_generate_random (ubyte* output, size_t output_size);
