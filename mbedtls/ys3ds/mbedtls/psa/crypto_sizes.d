...
extern (D) auto PSA_BITS_TO_BYTES(T)(auto ref T bits)
{
    return (bits + 7) / 8;
}

extern (D) auto PSA_BYTES_TO_BITS(T)(auto ref T bytes)
{
    return bytes * 8;
}

extern (D) auto PSA_ROUND_UP_TO_MULTIPLE(T0, T1)(auto ref T0 block_size, auto ref T1 length)
{
 ...
 */
extern (D) int PSA_HASH_BLOCK_LENGTH(T)(auto ref T alg)
{
    return PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD2 ? 16 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD4 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD5 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_RIPEMD160 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_1 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_224 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_256 ? 64 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_384 ? 128 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512 ? 128 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512_224 ? 128 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512_256 ? 128 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_224 ? 144 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_256 ? 136 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_384 ? 104 : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_512 ? 72 : 0;
}
...
enum PSA_HASH_MAX_SIZE = 32;
enum PSA_HMAC_MAX_HASH_BLOCK_SIZE = 64;
 ...
 * to 64 bytes.
 */
enum PSA_MAC_MAX_SIZE = PSA_HASH_MAX_SIZE;
...
enum PSA_VENDOR_RSA_MAX_KEY_BITS = 4096;

/* The maximum size of an ECC key on this implementation, in bits.
 * This is a vendor-specific macro. */
enum PSA_VENDOR_ECC_MAX_CURVE_BITS = 521;
 ...
 */
enum PSA_TLS12_PSK_TO_MS_PSK_MAX_SIZE = 128;

/** The maximum size of a block cipher. */
enum PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE = 16;
 ...
 *                            return 0.
 */
extern (D) auto PSA_AEAD_ENCRYPT_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 plaintext_length)
{
    return PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? plaintext_length + PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : 0;
}
 ...
 *
 */
extern (D) auto PSA_AEAD_ENCRYPT_OUTPUT_MAX_SIZE(T)(auto ref T plaintext_length)
{
 ...
 *                            return 0.
 */
extern (D) auto PSA_AEAD_DECRYPT_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 ciphertext_length)
{
    return PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 && ciphertext_length > PSA_ALG_AEAD_GET_TAG_LENGTH(alg) ? ciphertext_length - PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : 0;
}
 ...
 *
 */
extern (D) auto PSA_AEAD_DECRYPT_OUTPUT_MAX_SIZE(T)(auto ref T ciphertext_length)
{
 ...
 */
extern (D) int PSA_AEAD_NONCE_LENGTH(T0, T1)(auto ref T0 key_type, auto ref T1 alg)
{
    return PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) == 16 ? MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CCM) ? 13 : MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_GCM) ? 12 : 0 : key_type == PSA_KEY_TYPE_CHACHA20 && MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CHACHA20_POLY1305) ? 12 : 0;
}
 ...
 */
enum PSA_AEAD_NONCE_MAX_SIZE = 13;
...
extern (D) auto PSA_AEAD_UPDATE_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 input_length)
{
    return PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg) ? PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), input_length) : input_length : 0;
}
 ...
 * \param input_length      Size of the input in bytes.
 */
extern (D) auto PSA_AEAD_UPDATE_OUTPUT_MAX_SIZE(T)(auto ref T input_length)
{
 ...
 *                            return 0.
 */
extern (D) auto PSA_AEAD_FINISH_OUTPUT_SIZE(T0, T1)(auto ref T0 key_type, auto ref T1 alg)
{
    return PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 && PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg) ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : 0;
}
 ...
 */
enum PSA_AEAD_FINISH_OUTPUT_MAX_SIZE = PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE;
 ...
 *                            return 0.
 */
extern (D) auto PSA_AEAD_VERIFY_OUTPUT_SIZE(T0, T1)(auto ref T0 key_type, auto ref T1 alg)
{
    return PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 && PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg) ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : 0;
}
 ...
 */
enum PSA_AEAD_VERIFY_OUTPUT_MAX_SIZE = PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE;
 ...
 */
extern (D) auto PSA_ECDSA_SIGNATURE_SIZE(T)(auto ref T curve_bits)
{
    return PSA_BITS_TO_BYTES(curve_bits) * 2;
}
...
enum PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE = PSA_ECDSA_SIGNATURE_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS);
 ...
 */
enum PSA_SIGNATURE_MAX_SIZE = PSA_BITS_TO_BYTES(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE ? PSA_BITS_TO_BYTES(PSA_VENDOR_RSA_MAX_KEY_BITS) : PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE;
...
enum PSA_ASYMMETRIC_ENCRYPT_OUTPUT_MAX_SIZE = PSA_BITS_TO_BYTES(PSA_VENDOR_RSA_MAX_KEY_BITS);
 ...
 *         return value is unspecified.
 */
extern (D) auto PSA_ASYMMETRIC_DECRYPT_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 key_bits, auto ref T2 alg)
{
    return PSA_KEY_TYPE_IS_RSA(key_type) ? PSA_BITS_TO_BYTES(key_bits) - PSA_RSA_MINIMUM_PADDING_SIZE(alg) : 0;
}
 ...
 */
enum PSA_ASYMMETRIC_DECRYPT_OUTPUT_MAX_SIZE = PSA_BITS_TO_BYTES(PSA_VENDOR_RSA_MAX_KEY_BITS);
 ...
 */
extern (D) auto PSA_KEY_EXPORT_ASN1_INTEGER_MAX_SIZE(T)(auto ref T bits)
{
    return bits / 8 + 5;
}
 ...
 */
extern (D) auto PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(T)(auto ref T key_bits)
{
    return PSA_KEY_EXPORT_ASN1_INTEGER_MAX_SIZE(key_bits) + 11;
}
 ...
 * - 7 bytes for the public exponent.
 */
extern (D) auto PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(T)(auto ref T key_bits)
{
    return 9 * PSA_KEY_EXPORT_ASN1_INTEGER_MAX_SIZE(key_bits / 2 + 1) + 14;
}
 ...
 */
extern (D) auto PSA_KEY_EXPORT_DSA_PUBLIC_KEY_MAX_SIZE(T)(auto ref T key_bits)
{
    return PSA_KEY_EXPORT_ASN1_INTEGER_MAX_SIZE(key_bits) * 3 + 59;
}
 ...
 */
extern (D) auto PSA_KEY_EXPORT_DSA_KEY_PAIR_MAX_SIZE(T)(auto ref T key_bits)
{
    return PSA_KEY_EXPORT_ASN1_INTEGER_MAX_SIZE(key_bits) * 3 + 75;
}
 ...
 * - 1 byte + 2 * point size.
 */
extern (D) auto PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(T)(auto ref T key_bits)
{
    return 2 * PSA_BITS_TO_BYTES(key_bits) + 1;
}
 ...
 */
extern (D) auto PSA_KEY_EXPORT_ECC_KEY_PAIR_MAX_SIZE(T)(auto ref T key_bits)
{
 ...
 *                          \p key_bits).
 */
extern (D) auto PSA_EXPORT_PUBLIC_KEY_OUTPUT_SIZE(T0, T1)(auto ref T0 key_type, auto ref T1 key_bits)
{
    return PSA_KEY_TYPE_IS_RSA(key_type) ? PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(key_bits) : PSA_KEY_TYPE_IS_ECC(key_type) ? PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(key_bits) : 0;
}
 ...
 */
enum PSA_EXPORT_KEY_PAIR_MAX_SIZE = PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_KEY_EXPORT_ECC_KEY_PAIR_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS) ? PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) : PSA_KEY_EXPORT_ECC_KEY_PAIR_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS);
 ...
 */
enum PSA_EXPORT_PUBLIC_KEY_MAX_SIZE = PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS) ? PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) : PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS);
...
extern (D) auto PSA_RAW_KEY_AGREEMENT_OUTPUT_SIZE(T0, T1)(auto ref T0 key_type, auto ref T1 key_bits)
{
    return PSA_KEY_TYPE_IS_ECC_KEY_PAIR(key_type) ? PSA_BITS_TO_BYTES(key_bits) : 0;
}
 ...
 */
enum PSA_RAW_KEY_AGREEMENT_OUTPUT_MAX_SIZE = PSA_BITS_TO_BYTES(PSA_VENDOR_ECC_MAX_CURVE_BITS);
 ...
 *         or the parameters are incompatible, return 0.
 */
extern (D) auto PSA_CIPHER_IV_LENGTH(T0, T1)(auto ref T0 key_type, auto ref T1 alg)
{
    return PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) > 1 && (alg == PSA_ALG_CTR || alg == PSA_ALG_CFB || alg == PSA_ALG_OFB || alg == PSA_ALG_XTS || alg == PSA_ALG_CBC_NO_PADDING || alg == PSA_ALG_CBC_PKCS7) ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : key_type == PSA_KEY_TYPE_CHACHA20 && alg == PSA_ALG_STREAM_CIPHER ? 12 : 0;
}
 ...
 */
enum PSA_CIPHER_IV_MAX_SIZE = 16;
 ...
 *                      return 0.
 */
extern (D) auto PSA_CIPHER_ENCRYPT_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 input_length)
{
    return alg == PSA_ALG_CBC_PKCS7 ? (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) != 0 ? PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), input_length + 1) + PSA_CIPHER_IV_LENGTH(key_type, alg) : 0) : (PSA_ALG_IS_CIPHER(alg) ? input_length + PSA_CIPHER_IV_LENGTH(key_type, alg) : 0);
}
 ...
 *
 */
extern (D) auto PSA_CIPHER_ENCRYPT_OUTPUT_MAX_SIZE(T)(auto ref T input_length)
{
    return PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE, input_length + 1) + PSA_CIPHER_IV_MAX_SIZE;
}
 ...
 *                      return 0.
 */
extern (D) auto PSA_CIPHER_DECRYPT_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 input_length)
{
    return PSA_ALG_IS_CIPHER(alg) && (key_type & PSA_KEY_TYPE_CATEGORY_MASK) == PSA_KEY_TYPE_CATEGORY_SYMMETRIC ? input_length : 0;
}
 ...
 * \param input_length  Size of the input in bytes.
 */
extern (D) auto PSA_CIPHER_DECRYPT_OUTPUT_MAX_SIZE(T)(auto ref T input_length)
{
    return input_length;
}
 ...
 */
extern (D) auto PSA_CIPHER_UPDATE_OUTPUT_SIZE(T0, T1, T2)(auto ref T0 key_type, auto ref T1 alg, auto ref T2 input_length)
{
    return PSA_ALG_IS_CIPHER(alg) ? (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) != 0 ? ((alg == PSA_ALG_CBC_PKCS7 || alg == PSA_ALG_CBC_NO_PADDING || alg == PSA_ALG_ECB_NO_PADDING) ? PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), input_length) : input_length) : 0) : 0;
}
 ...
 * \param input_length  Size of the input in bytes.
 */
extern (D) auto PSA_CIPHER_UPDATE_OUTPUT_MAX_SIZE(T)(auto ref T input_length)
{
    return PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE, input_length);
}
 ...
 *                      recognized, or the parameters are incompatible, return 0.
 */
extern (D) auto PSA_CIPHER_FINISH_OUTPUT_SIZE(T0, T1)(auto ref T0 key_type, auto ref T1 alg)
{
    return PSA_ALG_IS_CIPHER(alg) ? (alg == PSA_ALG_CBC_PKCS7 ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : 0) : 0;
}
 ...
 */
enum PSA_CIPHER_FINISH_OUTPUT_MAX_SIZE = PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE;
