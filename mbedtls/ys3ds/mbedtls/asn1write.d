 ...
 */
int mbedtls_asn1_write_len (ubyte** p, ubyte* start, size_t len);
/**
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_tag (ubyte** p, ubyte* start, ubyte tag);
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_raw_buffer (
    ubyte** p,
    ubyte* start,
    const(ubyte)* buf,
    size_t size);
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_mpi (ubyte** p, ubyte* start, const(mbedtls_mpi)* X);
/* MBEDTLS_BIGNUM_C */
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_null (ubyte** p, ubyte* start);
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_bool (ubyte** p, ubyte* start, int boolean);
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_int (ubyte** p, ubyte* start, int val);
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int mbedtls_asn1_write_enum (ubyte** p, ubyte* start, int val);
 ...
 * \return          A negative error code on failure.
 */
int mbedtls_asn1_write_printable_string (
    ubyte** p,
    ubyte* start,
    const(char)* text,
    size_t text_len);
 ...
 * \return          A negative error code on failure.
 */
int mbedtls_asn1_write_utf8_string (
    ubyte** p,
    ubyte* start,
    const(char)* text,
    size_t text_len);
 ...
 * \return          A negative error code on failure.
 */
int mbedtls_asn1_write_bitstring (
    ubyte** p,
    ubyte* start,
    const(ubyte)* buf,
    size_t bits);
 ...
 * \return          A negative error code on failure.
 */
int mbedtls_asn1_write_named_bitstring (
    ubyte** p,
    ubyte* start,
    const(ubyte)* buf,
    size_t bits);
 ...
 * \return          A negative error code on failure.
 */
int mbedtls_asn1_write_octet_string (
    ubyte** p,
    ubyte* start,
    const(ubyte)* buf,
    size_t size);
