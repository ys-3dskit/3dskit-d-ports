...
enum MBEDTLS_ERR_HMAC_DRBG_REQUEST_TOO_BIG = -0x0003;
/** Input too large (Entropy + additional). */
enum MBEDTLS_ERR_HMAC_DRBG_INPUT_TOO_BIG = -0x0005;
/** Read/write error in file. */
enum MBEDTLS_ERR_HMAC_DRBG_FILE_IO_ERROR = -0x0007;
/** The entropy source failed. */
enum MBEDTLS_ERR_HMAC_DRBG_ENTROPY_SOURCE_FAILED = -0x0009;
...
enum MBEDTLS_HMAC_DRBG_RESEED_INTERVAL = 10000; /**< Interval before reseed is performed by default */

enum MBEDTLS_HMAC_DRBG_MAX_INPUT = 256; /**< Maximum number of additional input bytes */

enum MBEDTLS_HMAC_DRBG_MAX_REQUEST = 1024; /**< Maximum number of requested bytes per call */

enum MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT = 384; /**< Maximum size of (re)seed buffer */

/** \} name SECTION: Module settings */

enum MBEDTLS_HMAC_DRBG_PR_OFF = 0; /**< No prediction resistance       */
enum MBEDTLS_HMAC_DRBG_PR_ON = 1; /**< Prediction resistance enabled  */
...
struct mbedtls_hmac_drbg_context
{
    ...
    ubyte[MBEDTLS_MD_MAX_SIZE] V; /*!< V in the spec          */
    ...
    /* Callbacks */
    int function (void*, ubyte*, size_t) f_entropy; /*!< entropy function */
...
int mbedtls_hmac_drbg_seed (
    ...
    int function (void*, ubyte*, size_t) f_entropy,
    void* p_entropy,
    const(ubyte)* custom,
    size_t len);
 ...
 */
void mbedtls_hmac_drbg_set_prediction_resistance (
    mbedtls_hmac_drbg_context* ctx,
    int resistance);
 ...
 */
void mbedtls_hmac_drbg_set_reseed_interval (
    mbedtls_hmac_drbg_context* ctx,
    int interval);
 ...
 *                      hash calculation.
 */
int mbedtls_hmac_drbg_update_ret (
    mbedtls_hmac_drbg_context* ctx,
 ...
 */
int mbedtls_hmac_drbg_random (void* p_rng, ubyte* output, size_t out_len);
