 ...
 */
enum mbedtls_everest_ecdh_side
{
    MBEDTLS_EVEREST_ECDH_OURS = 0, /**< Our key. */
    MBEDTLS_EVEREST_ECDH_THEIRS = 1 /**< The key of the peer. */
}

struct mbedtls_ecdh_context_everest
{
 ...
 */
int mbedtls_everest_make_params (
    mbedtls_ecdh_context_everest* ctx,
    size_t* olen,
    ubyte* buf,
    size_t blen,
 ...
 *
 */
int mbedtls_everest_read_params (
    mbedtls_ecdh_context_everest* ctx,
    const(ubyte*)* buf,
    const(ubyte)* end);
 ...
 *
 */
int mbedtls_everest_get_params (
    mbedtls_ecdh_context_everest* ctx,
 ...
 * \return          An \c MBEDTLS_ERR_ECP_XXX error code on failure.
 */
int mbedtls_everest_make_public (
    mbedtls_ecdh_context_everest* ctx,
    size_t* olen,
    ubyte* buf,
    size_t blen,
 ...
 * \return      An \c MBEDTLS_ERR_ECP_XXX error code on failure.
 */
int mbedtls_everest_read_public (
    mbedtls_ecdh_context_everest* ctx,
    const(ubyte)* buf,
    size_t blen);
 ...
 * \return          An \c MBEDTLS_ERR_ECP_XXX error code on failure.
 */
int mbedtls_everest_calc_secret (
    mbedtls_ecdh_context_everest* ctx,
    size_t* olen,
    ubyte* buf,
    size_t blen,
