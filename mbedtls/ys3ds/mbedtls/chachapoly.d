...
enum MBEDTLS_ERR_CHACHAPOLY_BAD_STATE = -0x0054;
/** Authenticated decryption failed: data was not authentic. */
enum MBEDTLS_ERR_CHACHAPOLY_AUTH_FAILED = -0x0056;

enum mbedtls_chachapoly_mode_t
{
    MBEDTLS_CHACHAPOLY_ENCRYPT = 0, /**< The mode value for performing encryption. */
    MBEDTLS_CHACHAPOLY_DECRYPT = 1 /**< The mode value for performing decryption. */
}
...
struct mbedtls_chachapoly_context
{
    ...
    ulong aad_len; /**< The length (bytes) of the Additional Authenticated Data. */
    ulong ciphertext_len; /**< The length (bytes) of the ciphertext. */
 ...
 */
int mbedtls_chachapoly_update_aad (
    mbedtls_chachapoly_context* ctx,
    const(ubyte)* aad,
    size_t aad_len);
