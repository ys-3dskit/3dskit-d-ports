...
extern (D) auto MBEDTLS_DEPRECATED_STRING_CONSTANT(T)(auto ref T VAL)
{
    return VAL;
}

extern (D) auto MBEDTLS_DEPRECATED_NUMERIC_CONSTANT(T)(auto ref T VAL)
{
    return VAL;
}
 ...
 */
extern (D) auto MBEDTLS_IGNORE_RETURN(T)(auto ref T result)
{
 ...
 *              NULL
 */
tm* mbedtls_platform_gmtime_r (const(mbedtls_time_t)* tt, tm* tm_buf);
/* MBEDTLS_HAVE_TIME_DATE */

/* MBEDTLS_PLATFORM_UTIL_H */
