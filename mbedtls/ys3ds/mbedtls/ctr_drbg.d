...
enum MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG = -0x0036;
/** The input (entropy + additional data) is too large. */
enum MBEDTLS_ERR_CTR_DRBG_INPUT_TOO_BIG = -0x0038;
/** Read or write error in file. */
enum MBEDTLS_ERR_CTR_DRBG_FILE_IO_ERROR = -0x003A;

enum MBEDTLS_CTR_DRBG_BLOCKSIZE = 16; /**< The block size used by the cipher. */
...
enum MBEDTLS_CTR_DRBG_KEYSIZE = 32;
/**< The key size in bytes used by the cipher.
 *
...
enum MBEDTLS_CTR_DRBG_KEYBITS = MBEDTLS_CTR_DRBG_KEYSIZE * 8; /**< The key size for the DRBG operation, in bits. */
enum MBEDTLS_CTR_DRBG_SEEDLEN = MBEDTLS_CTR_DRBG_KEYSIZE + MBEDTLS_CTR_DRBG_BLOCKSIZE; /**< The seed length, calculated as (counter + AES key). */
 ...
 */
enum MBEDTLS_CTR_DRBG_ENTROPY_LEN = 48;
...
enum MBEDTLS_CTR_DRBG_RESEED_INTERVAL = 10000;
/**< The interval before reseed is performed by default. */

enum MBEDTLS_CTR_DRBG_MAX_INPUT = 256;
/**< The maximum number of additional input Bytes. */

enum MBEDTLS_CTR_DRBG_MAX_REQUEST = 1024;
/**< The maximum number of requested Bytes per call. */

enum MBEDTLS_CTR_DRBG_MAX_SEED_INPUT = 384;
/**< The maximum size of seed or reseed buffer in bytes. */

/** \} name SECTION: Module settings */

enum MBEDTLS_CTR_DRBG_PR_OFF = 0;
/**< Prediction resistance is disabled. */
enum MBEDTLS_CTR_DRBG_PR_ON = 1;
 ...
 */
enum MBEDTLS_CTR_DRBG_ENTROPY_NONCE_LEN = 0;
...
{
    ubyte[16] counter; /*!< The counter (V). */
 ...
 */
int mbedtls_ctr_drbg_update_ret (
    mbedtls_ctr_drbg_context* ctx,
    const(ubyte)* additional,
    size_t add_len);
