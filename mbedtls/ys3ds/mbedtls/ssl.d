...
enum MBEDTLS_ERR_SSL_FEATURE_UNAVAILABLE = -0x7080;
/** Bad input parameters to function. */
enum MBEDTLS_ERR_SSL_BAD_INPUT_DATA = -0x7100;
/** Verification of the message MAC failed. */
enum MBEDTLS_ERR_SSL_INVALID_MAC = -0x7180;
/** An invalid SSL record was received. */
enum MBEDTLS_ERR_SSL_INVALID_RECORD = -0x7200;
/** The connection indicated an EOF. */
enum MBEDTLS_ERR_SSL_CONN_EOF = -0x7280;
/** An unknown cipher was received. */
enum MBEDTLS_ERR_SSL_UNKNOWN_CIPHER = -0x7300;
/** The server has no ciphersuites in common with the client. */
enum MBEDTLS_ERR_SSL_NO_CIPHER_CHOSEN = -0x7380;
/** No RNG was provided to the SSL module. */
enum MBEDTLS_ERR_SSL_NO_RNG = -0x7400;
/** No client certification received from the client, but required by the authentication mode. */
enum MBEDTLS_ERR_SSL_NO_CLIENT_CERTIFICATE = -0x7480;
/** Our own certificate(s) is/are too large to send in an SSL message. */
enum MBEDTLS_ERR_SSL_CERTIFICATE_TOO_LARGE = -0x7500;
/** The own certificate is not set, but needed by the server. */
enum MBEDTLS_ERR_SSL_CERTIFICATE_REQUIRED = -0x7580;
/** The own private key or pre-shared key is not set, but needed. */
enum MBEDTLS_ERR_SSL_PRIVATE_KEY_REQUIRED = -0x7600;
/** No CA Chain is set, but required to operate. */
enum MBEDTLS_ERR_SSL_CA_CHAIN_REQUIRED = -0x7680;
/** An unexpected message was received from our peer. */
enum MBEDTLS_ERR_SSL_UNEXPECTED_MESSAGE = -0x7700;
/** A fatal alert message was received from our peer. */
enum MBEDTLS_ERR_SSL_FATAL_ALERT_MESSAGE = -0x7780;
/** Verification of our peer failed. */
enum MBEDTLS_ERR_SSL_PEER_VERIFY_FAILED = -0x7800;
/** The peer notified us that the connection is going to be closed. */
enum MBEDTLS_ERR_SSL_PEER_CLOSE_NOTIFY = -0x7880;
/** Processing of the ClientHello handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CLIENT_HELLO = -0x7900;
/** Processing of the ServerHello handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO = -0x7980;
/** Processing of the Certificate handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE = -0x7A00;
/** Processing of the CertificateRequest handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_REQUEST = -0x7A80;
/** Processing of the ServerKeyExchange handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE = -0x7B00;
/** Processing of the ServerHelloDone handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO_DONE = -0x7B80;
/** Processing of the ClientKeyExchange handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE = -0x7C00;
/** Processing of the ClientKeyExchange handshake message failed in DHM / ECDH Read Public. */
enum MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_RP = -0x7C80;
/** Processing of the ClientKeyExchange handshake message failed in DHM / ECDH Calculate Secret. */
enum MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_CS = -0x7D00;
/** Processing of the CertificateVerify handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_VERIFY = -0x7D80;
/** Processing of the ChangeCipherSpec handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC = -0x7E00;
/** Processing of the Finished handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_FINISHED = -0x7E80;
/** Memory allocation failed */
enum MBEDTLS_ERR_SSL_ALLOC_FAILED = -0x7F00;
/** Hardware acceleration function returned with error */
enum MBEDTLS_ERR_SSL_HW_ACCEL_FAILED = -0x7F80;
/** Hardware acceleration function skipped / left alone data */
enum MBEDTLS_ERR_SSL_HW_ACCEL_FALLTHROUGH = -0x6F80;
/** Processing of the compression / decompression failed */
enum MBEDTLS_ERR_SSL_COMPRESSION_FAILED = -0x6F00;
/** Handshake protocol not within min/max boundaries */
enum MBEDTLS_ERR_SSL_BAD_HS_PROTOCOL_VERSION = -0x6E80;
/** Processing of the NewSessionTicket handshake message failed. */
enum MBEDTLS_ERR_SSL_BAD_HS_NEW_SESSION_TICKET = -0x6E00;
/** Session ticket has expired. */
enum MBEDTLS_ERR_SSL_SESSION_TICKET_EXPIRED = -0x6D80;
/** Public key type mismatch (eg, asked for RSA key exchange and presented EC key) */
enum MBEDTLS_ERR_SSL_PK_TYPE_MISMATCH = -0x6D00;
/** Unknown identity received (eg, PSK identity) */
enum MBEDTLS_ERR_SSL_UNKNOWN_IDENTITY = -0x6C80;
/** Internal error (eg, unexpected failure in lower-level module) */
enum MBEDTLS_ERR_SSL_INTERNAL_ERROR = -0x6C00;
/** A counter would wrap (eg, too many messages exchanged). */
enum MBEDTLS_ERR_SSL_COUNTER_WRAPPING = -0x6B80;
/** Unexpected message at ServerHello in renegotiation. */
enum MBEDTLS_ERR_SSL_WAITING_SERVER_HELLO_RENEGO = -0x6B00;
/** DTLS client must retry for hello verification */
enum MBEDTLS_ERR_SSL_HELLO_VERIFY_REQUIRED = -0x6A80;
/** A buffer is too small to receive or write a message */
enum MBEDTLS_ERR_SSL_BUFFER_TOO_SMALL = -0x6A00;
/** None of the common ciphersuites is usable (eg, no suitable certificate, see debug messages). */
enum MBEDTLS_ERR_SSL_NO_USABLE_CIPHERSUITE = -0x6980;
/** No data of requested type currently available on underlying transport. */
enum MBEDTLS_ERR_SSL_WANT_READ = -0x6900;
/** Connection requires a write call. */
enum MBEDTLS_ERR_SSL_WANT_WRITE = -0x6880;
/** The operation timed out. */
enum MBEDTLS_ERR_SSL_TIMEOUT = -0x6800;
...
enum MBEDTLS_ERR_SSL_UNEXPECTED_RECORD = -0x6700;
/** The alert message received indicates a non-fatal error. */
enum MBEDTLS_ERR_SSL_NON_FATAL = -0x6680;
/** Couldn't set the hash for verifying CertificateVerify */
enum MBEDTLS_ERR_SSL_INVALID_VERIFY_HASH = -0x6600;
/** Internal-only message signaling that further message-processing should be done */
enum MBEDTLS_ERR_SSL_CONTINUE_PROCESSING = -0x6580;
/** The asynchronous operation is not completed yet. */
enum MBEDTLS_ERR_SSL_ASYNC_IN_PROGRESS = -0x6500;
/** Internal-only message signaling that a message arrived early. */
enum MBEDTLS_ERR_SSL_EARLY_MESSAGE = -0x6480;
/** An encrypted DTLS-frame with an unexpected CID was received. */
enum MBEDTLS_ERR_SSL_UNEXPECTED_CID = -0x6000;
/** An operation failed due to an unexpected version or configuration. */
enum MBEDTLS_ERR_SSL_VERSION_MISMATCH = -0x5F00;
/** A cryptographic operation is in progress. Try again later. */
enum MBEDTLS_ERR_SSL_CRYPTO_IN_PROGRESS = -0x7000;
/** Invalid value in SSL config */
enum MBEDTLS_ERR_SSL_BAD_CONFIG = -0x5E80;
/** Cache entry not found */
enum MBEDTLS_ERR_SSL_CACHE_ENTRY_NOT_FOUND = -0x5E00;

/*
 * Various constants
 */
enum MBEDTLS_SSL_MAJOR_VERSION_3 = 3;
enum MBEDTLS_SSL_MINOR_VERSION_0 = 0; /*!< SSL v3.0 */
enum MBEDTLS_SSL_MINOR_VERSION_1 = 1; /*!< TLS v1.0 */
enum MBEDTLS_SSL_MINOR_VERSION_2 = 2; /*!< TLS v1.1 */
enum MBEDTLS_SSL_MINOR_VERSION_3 = 3; /*!< TLS v1.2 */
enum MBEDTLS_SSL_MINOR_VERSION_4 = 4; /*!< TLS v1.3 (experimental) */

enum MBEDTLS_SSL_TRANSPORT_STREAM = 0; /*!< TLS      */
enum MBEDTLS_SSL_TRANSPORT_DATAGRAM = 1; /*!< DTLS     */

enum MBEDTLS_SSL_MAX_HOST_NAME_LEN = 255; /*!< Maximum host name defined in RFC 1035 */
enum MBEDTLS_SSL_MAX_ALPN_NAME_LEN = 255; /*!< Maximum size in bytes of a protocol name in alpn ext., RFC 7301 */

enum MBEDTLS_SSL_MAX_ALPN_LIST_LEN = 65535; /*!< Maximum size in bytes of list in alpn ext., RFC 7301          */

/* RFC 6066 section 4, see also mfl_code_to_length in ssl_tls.c
 * NONE must be zero so that memset()ing structure to zero works */
enum MBEDTLS_SSL_MAX_FRAG_LEN_NONE = 0; /*!< don't use this extension   */
enum MBEDTLS_SSL_MAX_FRAG_LEN_512 = 1; /*!< MaxFragmentLength 2^9      */
enum MBEDTLS_SSL_MAX_FRAG_LEN_1024 = 2; /*!< MaxFragmentLength 2^10     */
enum MBEDTLS_SSL_MAX_FRAG_LEN_2048 = 3; /*!< MaxFragmentLength 2^11     */
enum MBEDTLS_SSL_MAX_FRAG_LEN_4096 = 4; /*!< MaxFragmentLength 2^12     */
enum MBEDTLS_SSL_MAX_FRAG_LEN_INVALID = 5; /*!< first invalid value        */

enum MBEDTLS_SSL_IS_CLIENT = 0;
enum MBEDTLS_SSL_IS_SERVER = 1;

enum MBEDTLS_SSL_IS_NOT_FALLBACK = 0;
enum MBEDTLS_SSL_IS_FALLBACK = 1;

enum MBEDTLS_SSL_EXTENDED_MS_DISABLED = 0;
enum MBEDTLS_SSL_EXTENDED_MS_ENABLED = 1;

enum MBEDTLS_SSL_CID_DISABLED = 0;
enum MBEDTLS_SSL_CID_ENABLED = 1;

enum MBEDTLS_SSL_ETM_DISABLED = 0;
enum MBEDTLS_SSL_ETM_ENABLED = 1;

enum MBEDTLS_SSL_COMPRESS_NULL = 0;
enum MBEDTLS_SSL_COMPRESS_DEFLATE = 1;

enum MBEDTLS_SSL_VERIFY_NONE = 0;
enum MBEDTLS_SSL_VERIFY_OPTIONAL = 1;
enum MBEDTLS_SSL_VERIFY_REQUIRED = 2;
enum MBEDTLS_SSL_VERIFY_UNSET = 3; /* Used only for sni_authmode */

enum MBEDTLS_SSL_LEGACY_RENEGOTIATION = 0;
enum MBEDTLS_SSL_SECURE_RENEGOTIATION = 1;

enum MBEDTLS_SSL_RENEGOTIATION_DISABLED = 0;
enum MBEDTLS_SSL_RENEGOTIATION_ENABLED = 1;

enum MBEDTLS_SSL_ANTI_REPLAY_DISABLED = 0;
enum MBEDTLS_SSL_ANTI_REPLAY_ENABLED = 1;

enum MBEDTLS_SSL_RENEGOTIATION_NOT_ENFORCED = -1;
enum MBEDTLS_SSL_RENEGO_MAX_RECORDS_DEFAULT = 16;

enum MBEDTLS_SSL_LEGACY_NO_RENEGOTIATION = 0;
enum MBEDTLS_SSL_LEGACY_ALLOW_RENEGOTIATION = 1;
enum MBEDTLS_SSL_LEGACY_BREAK_HANDSHAKE = 2;

enum MBEDTLS_SSL_TRUNC_HMAC_DISABLED = 0;
enum MBEDTLS_SSL_TRUNC_HMAC_ENABLED = 1;
enum MBEDTLS_SSL_TRUNCATED_HMAC_LEN = 10; /* 80 bits, rfc 6066 section 7 */

enum MBEDTLS_SSL_SESSION_TICKETS_DISABLED = 0;
enum MBEDTLS_SSL_SESSION_TICKETS_ENABLED = 1;

enum MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED = 0;
enum MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED = 1;

enum MBEDTLS_SSL_ARC4_ENABLED = 0;
enum MBEDTLS_SSL_ARC4_DISABLED = 1;

enum MBEDTLS_SSL_PRESET_DEFAULT = 0;
enum MBEDTLS_SSL_PRESET_SUITEB = 2;

enum MBEDTLS_SSL_CERT_REQ_CA_LIST_ENABLED = 1;
enum MBEDTLS_SSL_CERT_REQ_CA_LIST_DISABLED = 0;

enum MBEDTLS_SSL_DTLS_SRTP_MKI_UNSUPPORTED = 0;
enum MBEDTLS_SSL_DTLS_SRTP_MKI_SUPPORTED = 1;

/*
 * Default range for DTLS retransmission timer value, in milliseconds.
 * RFC 6347 4.2.4.1 says from 1 second to 60 seconds.
 */
enum MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MIN = 1000;
enum MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MAX = 60000;
...
enum MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME = 86400; /**< Lifetime of session tickets (if enabled) */
...
enum MBEDTLS_SSL_MAX_CONTENT_LEN = 16384; /**< Size of the input / output buffer */

enum MBEDTLS_SSL_IN_CONTENT_LEN = MBEDTLS_SSL_MAX_CONTENT_LEN;

enum MBEDTLS_SSL_OUT_CONTENT_LEN = MBEDTLS_SSL_MAX_CONTENT_LEN;
...
enum MBEDTLS_SSL_DTLS_MAX_BUFFERING = 32768;

/*
 * Maximum length of CIDs for incoming and outgoing messages.
 */

enum MBEDTLS_SSL_CID_IN_LEN_MAX = 32;

enum MBEDTLS_SSL_CID_OUT_LEN_MAX = 32;

enum MBEDTLS_SSL_CID_PADDING_GRANULARITY = 16;

enum MBEDTLS_SSL_TLS1_3_PADDING_GRANULARITY = 1;
...
enum MBEDTLS_SSL_VERIFY_DATA_MAX_LEN = 12;

/*
 * Signaling ciphersuite values (SCSV)
 */
enum MBEDTLS_SSL_EMPTY_RENEGOTIATION_INFO = 0xFF; /**< renegotiation info ext */
enum MBEDTLS_SSL_FALLBACK_SCSV_VALUE = 0x5600; /**< RFC 7507 section 2 */

/*
 * Supported Signature and Hash algorithms (For TLS 1.2)
 * RFC 5246 section 7.4.1.4.1
 */
enum MBEDTLS_SSL_HASH_NONE = 0;
enum MBEDTLS_SSL_HASH_MD5 = 1;
enum MBEDTLS_SSL_HASH_SHA1 = 2;
enum MBEDTLS_SSL_HASH_SHA224 = 3;
enum MBEDTLS_SSL_HASH_SHA256 = 4;
enum MBEDTLS_SSL_HASH_SHA384 = 5;
enum MBEDTLS_SSL_HASH_SHA512 = 6;

enum MBEDTLS_SSL_SIG_ANON = 0;
enum MBEDTLS_SSL_SIG_RSA = 1;
enum MBEDTLS_SSL_SIG_ECDSA = 3;

/*
 * Client Certificate Types
 * RFC 5246 section 7.4.4 plus RFC 4492 section 5.5
 */
enum MBEDTLS_SSL_CERT_TYPE_RSA_SIGN = 1;
enum MBEDTLS_SSL_CERT_TYPE_ECDSA_SIGN = 64;

/*
 * Message, alert and handshake types
 */
enum MBEDTLS_SSL_MSG_CHANGE_CIPHER_SPEC = 20;
enum MBEDTLS_SSL_MSG_ALERT = 21;
enum MBEDTLS_SSL_MSG_HANDSHAKE = 22;
enum MBEDTLS_SSL_MSG_APPLICATION_DATA = 23;
enum MBEDTLS_SSL_MSG_CID = 25;

enum MBEDTLS_SSL_ALERT_LEVEL_WARNING = 1;
enum MBEDTLS_SSL_ALERT_LEVEL_FATAL = 2;

enum MBEDTLS_SSL_ALERT_MSG_CLOSE_NOTIFY = 0; /* 0x00 */
enum MBEDTLS_SSL_ALERT_MSG_UNEXPECTED_MESSAGE = 10; /* 0x0A */
enum MBEDTLS_SSL_ALERT_MSG_BAD_RECORD_MAC = 20; /* 0x14 */
enum MBEDTLS_SSL_ALERT_MSG_DECRYPTION_FAILED = 21; /* 0x15 */
enum MBEDTLS_SSL_ALERT_MSG_RECORD_OVERFLOW = 22; /* 0x16 */
enum MBEDTLS_SSL_ALERT_MSG_DECOMPRESSION_FAILURE = 30; /* 0x1E */
enum MBEDTLS_SSL_ALERT_MSG_HANDSHAKE_FAILURE = 40; /* 0x28 */
enum MBEDTLS_SSL_ALERT_MSG_NO_CERT = 41; /* 0x29 */
enum MBEDTLS_SSL_ALERT_MSG_BAD_CERT = 42; /* 0x2A */
enum MBEDTLS_SSL_ALERT_MSG_UNSUPPORTED_CERT = 43; /* 0x2B */
enum MBEDTLS_SSL_ALERT_MSG_CERT_REVOKED = 44; /* 0x2C */
enum MBEDTLS_SSL_ALERT_MSG_CERT_EXPIRED = 45; /* 0x2D */
enum MBEDTLS_SSL_ALERT_MSG_CERT_UNKNOWN = 46; /* 0x2E */
enum MBEDTLS_SSL_ALERT_MSG_ILLEGAL_PARAMETER = 47; /* 0x2F */
enum MBEDTLS_SSL_ALERT_MSG_UNKNOWN_CA = 48; /* 0x30 */
enum MBEDTLS_SSL_ALERT_MSG_ACCESS_DENIED = 49; /* 0x31 */
enum MBEDTLS_SSL_ALERT_MSG_DECODE_ERROR = 50; /* 0x32 */
enum MBEDTLS_SSL_ALERT_MSG_DECRYPT_ERROR = 51; /* 0x33 */
enum MBEDTLS_SSL_ALERT_MSG_EXPORT_RESTRICTION = 60; /* 0x3C */
enum MBEDTLS_SSL_ALERT_MSG_PROTOCOL_VERSION = 70; /* 0x46 */
enum MBEDTLS_SSL_ALERT_MSG_INSUFFICIENT_SECURITY = 71; /* 0x47 */
enum MBEDTLS_SSL_ALERT_MSG_INTERNAL_ERROR = 80; /* 0x50 */
enum MBEDTLS_SSL_ALERT_MSG_INAPROPRIATE_FALLBACK = 86; /* 0x56 */
enum MBEDTLS_SSL_ALERT_MSG_USER_CANCELED = 90; /* 0x5A */
enum MBEDTLS_SSL_ALERT_MSG_NO_RENEGOTIATION = 100; /* 0x64 */
enum MBEDTLS_SSL_ALERT_MSG_UNSUPPORTED_EXT = 110; /* 0x6E */
enum MBEDTLS_SSL_ALERT_MSG_UNRECOGNIZED_NAME = 112; /* 0x70 */
enum MBEDTLS_SSL_ALERT_MSG_UNKNOWN_PSK_IDENTITY = 115; /* 0x73 */
enum MBEDTLS_SSL_ALERT_MSG_NO_APPLICATION_PROTOCOL = 120; /* 0x78 */

enum MBEDTLS_SSL_HS_HELLO_REQUEST = 0;
enum MBEDTLS_SSL_HS_CLIENT_HELLO = 1;
enum MBEDTLS_SSL_HS_SERVER_HELLO = 2;
enum MBEDTLS_SSL_HS_HELLO_VERIFY_REQUEST = 3;
enum MBEDTLS_SSL_HS_NEW_SESSION_TICKET = 4;
enum MBEDTLS_SSL_HS_CERTIFICATE = 11;
enum MBEDTLS_SSL_HS_SERVER_KEY_EXCHANGE = 12;
enum MBEDTLS_SSL_HS_CERTIFICATE_REQUEST = 13;
enum MBEDTLS_SSL_HS_SERVER_HELLO_DONE = 14;
enum MBEDTLS_SSL_HS_CERTIFICATE_VERIFY = 15;
enum MBEDTLS_SSL_HS_CLIENT_KEY_EXCHANGE = 16;
enum MBEDTLS_SSL_HS_FINISHED = 20;

/*
 * TLS extensions
 */
enum MBEDTLS_TLS_EXT_SERVERNAME = 0;
enum MBEDTLS_TLS_EXT_SERVERNAME_HOSTNAME = 0;

enum MBEDTLS_TLS_EXT_MAX_FRAGMENT_LENGTH = 1;

enum MBEDTLS_TLS_EXT_TRUNCATED_HMAC = 4;

enum MBEDTLS_TLS_EXT_SUPPORTED_ELLIPTIC_CURVES = 10;
enum MBEDTLS_TLS_EXT_SUPPORTED_POINT_FORMATS = 11;

enum MBEDTLS_TLS_EXT_SIG_ALG = 13;

enum MBEDTLS_TLS_EXT_USE_SRTP = 14;

enum MBEDTLS_TLS_EXT_ALPN = 16;

enum MBEDTLS_TLS_EXT_ENCRYPT_THEN_MAC = 22; /* 0x16 */
enum MBEDTLS_TLS_EXT_EXTENDED_MASTER_SECRET = 0x0017; /* 23 */

enum MBEDTLS_TLS_EXT_SESSION_TICKET = 35;
...
enum MBEDTLS_TLS_EXT_CID = 254; /* TBD */

enum MBEDTLS_TLS_EXT_ECJPAKE_KKPP = 256; /* experimental */

enum MBEDTLS_TLS_EXT_RENEGOTIATION_INFO = 0xFF01;

/*
 * Size defines
 */

enum MBEDTLS_PSK_MAX_LEN = 32; /* 256 bits */

/* Dummy type used only for its size */
union mbedtls_ssl_premaster_secret
{
    ubyte dummy; /* Make the union non-empty even with SSL disabled */

    ubyte[48] _pms_rsa; /* RFC 5246 8.1.1 */

    ubyte[MBEDTLS_MPI_MAX_SIZE] _pms_dhm; /* RFC 5246 8.1.2 */

    ubyte[66] _pms_ecdh; /* RFC 4492 5.10 */

    ubyte[68] _pms_psk; /* RFC 4279 2 */

    ubyte[1060] _pms_dhe_psk; /* RFC 4279 3 */

    ubyte[84] _pms_rsa_psk; /* RFC 4279 4 */

    ubyte[102] _pms_ecdhe_psk; /* RFC 5489 2 */

    /* Thread spec: SHA-256 output */
}

enum MBEDTLS_PREMASTER_SIZE = mbedtls_ssl_premaster_secret.sizeof;
 ...
 */
alias mbedtls_ssl_send_t = int function (
    void* ctx,
    const(ubyte)* buf,
    size_t len);
 ...
 */
alias mbedtls_ssl_recv_t = int function (void* ctx, ubyte* buf, size_t len);
 ...
 *                 received and written to the buffer.
 */
alias mbedtls_ssl_recv_timeout_t = int function (
    void* ctx,
    ubyte* buf,
    size_t len,
    uint timeout);
 ...
 */
alias mbedtls_ssl_set_timer_t = void function (
    void* ctx,
    uint int_ms,
    uint fin_ms);
 ...
 */
alias mbedtls_ssl_get_timer_t = int function (void* ctx);
...
{
    ubyte mfl_code; /*!< MaxFragmentLength negotiated by peer */
    ...
    ubyte[32] id; /*!< session identifier */
    ubyte[48] master; /*!< the master secret  */
    ...
    ubyte* ticket; /*!< RFC 5077 session ticket */
    size_t ticket_len; /*!< session ticket length   */
    uint ticket_lifetime; /*!< ticket lifetime hint    */
    /* MBEDTLS_SSL_SESSION_TICKETS && MBEDTLS_SSL_CLI_C */
...
struct mbedtls_ssl_config
{
    ...
    ubyte max_major_ver; /*!< max. major version used            */
    ubyte max_minor_ver; /*!< max. minor version used            */
    ubyte min_major_ver; /*!< min. major version used            */
    ubyte min_minor_ver; /*!< min. minor version used            */
    ...
    ubyte endpoint; /*bool*/ /*!< 0: client, 1: server               */
    ubyte transport; /*bool*/ /*!< stream (TLS) or datagram (DTLS)    */
    ubyte authmode; /*2 bits*/ /*!< MBEDTLS_SSL_VERIFY_XXX             */
    /* needed even with renego disabled for LEGACY_BREAK_HANDSHAKE          */
    ubyte allow_legacy_renegotiation; /*2 bits*/ /*!< MBEDTLS_LEGACY_XXX  */

    ubyte arc4_disabled; /*bool*/ /*!< blacklist RC4 ciphersuites?        */

    ubyte mfl_code; /*3 bits*/ /*!< desired fragment length            */

    ubyte encrypt_then_mac; /*bool*/ /*!< negotiate encrypt-then-mac?    */

    ubyte extended_ms; /*bool*/ /*!< negotiate extended master secret?  */

    ubyte anti_replay; /*bool*/ /*!< detect and prevent replay?         */

    ubyte cbc_record_splitting; /*bool*/ /*!< do cbc record splitting    */

    ubyte disable_renegotiation; /*bool*/ /*!< disable renegotiation?     */

    ubyte trunc_hmac; /*bool*/ /*!< negotiate truncated hmac?          */

    ubyte session_tickets; /*bool*/ /*!< use session tickets?           */

    ubyte fallback; /*bool*/ /*!< is this a fallback?                */

    ubyte cert_req_ca_list; /*bool*/ /*!< enable sending CA list in
       Certificate Request messages?     */

    /*bool*/ /*!< Determines whether DTLS
     *   record with unexpected CID
     *   should lead to failure.    */
    /* MBEDTLS_SSL_DTLS_CONNECTION_ID */

    /*bool*/ /*!< support having mki_value
    ...
    uint read_timeout; /*!< timeout for mbedtls_ssl_read (ms)  */

    uint hs_timeout_min; /*!< initial value of the handshake
         retransmission timeout (ms)        */
    uint hs_timeout_max; /*!< maximum value of the handshake
         retransmission timeout (ms)        */

    int renego_max_records; /*!< grace period for renegotiation     */
    ubyte[8] renego_period; /*!< value of the record counters
         that triggers renegotiation        */

    uint badmac_limit; /*!< limit of records with a bad MAC    */

    uint dhm_min_bitlen; /*!< min. bit length of the DHM prime   */

    /*
     * Pointers
     */

    const(int)*[4] ciphersuite_list; /*!< allowed ciphersuites per version   */

    /** Callback for printing debug output                                  */
    void function (void*, int, const(char)*, int, const(char)*) f_dbg;
    ...
    int function (void*, mbedtls_ssl_session*) f_get_cache;
    /** Callback to store a session into the cache                          */
    int function (void*, const(mbedtls_ssl_session)*) f_set_cache;
    void* p_cache; /*!< context for cache callbacks        */

    /** Callback for setting cert according to SNI extension                */
    int function (void*, mbedtls_ssl_context*, const(ubyte)*, size_t) f_sni;
    void* p_sni; /*!< context for SNI callback           */

    /** Callback to customize X.509 certificate chain verification          */
    int function (void*, mbedtls_x509_crt*, int, uint*) f_vrfy;
    void* p_vrfy; /*!< context for X.509 verify calllback */

    /** Callback to retrieve PSK key from identity                          */
    int function (void*, mbedtls_ssl_context*, const(ubyte)*, size_t) f_psk;
    ...
    int function (void*, mbedtls_ssl_session*, ubyte*, size_t) f_ticket_parse;
    void* p_ticket; /*!< context for the ticket callbacks   */
    /* MBEDTLS_SSL_SESSION_TICKETS && MBEDTLS_SSL_SRV_C */
    ...
    int function (
        ...
        const(ubyte)[32],
        const(ubyte)[32],
        mbedtls_tls_prf_types) f_export_keys_ext;
    ...
    ubyte* psk; /*!< The raw pre-shared key. This field should
    ...
    ubyte* psk_identity; /*!< The PSK identity for PSK negotiation.
     *   This field should only be set via
     *   mbedtls_ssl_conf_psk().
...
struct mbedtls_ssl_context
{
    ...
    uint badmac_seen; /*!< records with a bad MAC received    */
    ...
    int function () f_send; /*!< Callback for network send */
    int function () f_recv; /*!< Callback for network receive */
    int function () f_recv_timeout;
    ...
    void function () f_set_timer; /*!< set timer callback */
    int function () f_get_timer; /*!< get timer callback */

    /*
     * Record layer (incoming data)
     */
    ubyte* in_buf; /*!< input buffer                     */
    ubyte* in_ctr; /*!< 64-bit incoming message counter
         TLS: maintained by us
         DTLS: read from peer             */
    ubyte* in_hdr; /*!< start of record header           */

    /*!< The start of the CID;
     *   (the end is marked by in_len).   */
    /* MBEDTLS_SSL_DTLS_CONNECTION_ID */
    ubyte* in_len; /*!< two-bytes message length field   */
    ubyte* in_iv; /*!< ivlen-byte IV                    */
    ubyte* in_msg; /*!< message contents (in_iv+ivlen)   */
    ubyte* in_offt; /*!< read offset in application data  */
    ...
    ushort in_epoch; /*!< DTLS epoch for incoming records  */
    size_t next_record_offset; /*!< offset of the next record in datagram
         (equal to in_left if none)       */
    /* MBEDTLS_SSL_PROTO_DTLS */

    ulong in_window_top; /*!< last validated record seq_num    */
    ulong in_window; /*!< bitmask for replay detection     */
    ...
    ubyte disable_datagram_packing; /*!< Disable packing multiple records
     ...
     */
    ubyte* out_buf; /*!< output buffer                    */
    ubyte* out_ctr; /*!< 64-bit outgoing message counter  */
    ubyte* out_hdr; /*!< start of record header           */

    /*!< The start of the CID;
     *   (the end is marked by in_len).   */
    /* MBEDTLS_SSL_DTLS_CONNECTION_ID */
    ubyte* out_len; /*!< two-bytes message length field   */
    ubyte* out_iv; /*!< ivlen-byte IV                    */
    ubyte* out_msg; /*!< message contents (out_iv+ivlen)  */
    ...
    ubyte[8] cur_out_ctr; /*!<  Outgoing record sequence  number. */

    ushort mtu; /*!< path mtu, used to fragment outgoing messages */
    /* MBEDTLS_SSL_PROTO_DTLS */

    /*!<  zlib data buffer        */
    /* MBEDTLS_ZLIB_SUPPORT */

    byte split_done; /*!< current record already split? */
    ...
    ubyte* cli_id; /*!<  transport-level ID of the client  */
    size_t cli_id_len; /*!<  length of cli_id                  */
    /* MBEDTLS_SSL_DTLS_HELLO_VERIFY && MBEDTLS_SSL_SRV_C */
    ...
    char[MBEDTLS_SSL_VERIFY_DATA_MAX_LEN] own_verify_data; /*!<  previous handshake verify data */
    char[MBEDTLS_SSL_VERIFY_DATA_MAX_LEN] peer_verify_data; /*!<  previous handshake verify data */
    /* MBEDTLS_SSL_RENEGOTIATION */
 ...
 */
void mbedtls_ssl_set_mtu (mbedtls_ssl_context* ssl, ushort mtu);
/* MBEDTLS_SSL_PROTO_DTLS */
 ...
 */
void mbedtls_ssl_conf_read_timeout (mbedtls_ssl_config* conf, uint timeout);
...
void mbedtls_ssl_set_timer_cb (
    mbedtls_ssl_context* ssl,
    void* p_timer,
    void function () f_set_timer,
    int function () f_get_timer);
 ...
 */
alias mbedtls_ssl_ticket_write_t = int function (
    void* p_ticket,
 ...
 *                  a specific MBEDTLS_ERR_XXX code.
 */
alias mbedtls_ssl_export_keys_t = int function (
    void* p_expkey,
    const(ubyte)* ms,
    const(ubyte)* kb,
    size_t maclen,
 ...
 *                  a specific MBEDTLS_ERR_XXX code.
 */
alias mbedtls_ssl_export_keys_ext_t = int function (
    void* p_expkey,
    const(ubyte)* ms,
    const(ubyte)* kb,
    size_t maclen,
    size_t keylen,
    size_t ivlen,
    const(ubyte)[32] client_random,
    const(ubyte)[32] server_random,
 ...
 */
alias mbedtls_ssl_ticket_parse_t = int function (
    void* p_ticket,
...
void mbedtls_ssl_conf_session_tickets_cb (
    mbedtls_ssl_config* conf,
    int function () f_ticket_write,
    int function () f_ticket_parse,
    void* p_ticket);
/* MBEDTLS_SSL_SESSION_TICKETS && MBEDTLS_SSL_SRV_C */
 ...
 * \param p_export_keys     Context for the callback
 */
void mbedtls_ssl_conf_export_keys_ext_cb (
    mbedtls_ssl_config* conf,
    int function () f_export_keys_ext,
    void* p_export_keys);
/* MBEDTLS_SSL_EXPORT_KEYS */
 ...
 */
alias mbedtls_ssl_cookie_write_t = int function (
    void* ctx,
    ubyte** p,
    ubyte* end,
    const(ubyte)* info,
 ...
 *                 or a negative error code.
 */
alias mbedtls_ssl_cookie_check_t = int function (
    void* ctx,
    const(ubyte)* cookie,
    size_t clen,
    const(ubyte)* info,
...
void mbedtls_ssl_conf_dtls_cookies (
    mbedtls_ssl_config* conf,
    int function () f_cookie_write,
    int function () f_cookie_check,
    void* p_cookie);
 ...
 *                 many bogus packets.
 */
void mbedtls_ssl_conf_dtls_badmac_limit (mbedtls_ssl_config* conf, uint limit);
/* MBEDTLS_SSL_DTLS_BADMAC_LIMIT */
 ...
 */
void mbedtls_ssl_conf_handshake_timeout (mbedtls_ssl_config* conf, uint min, uint max);
/* MBEDTLS_SSL_PROTO_DTLS */
 ...
 */
void mbedtls_ssl_conf_ciphersuites_for_version (
    mbedtls_ssl_config* conf,
    const(int)* ciphersuites,
    int major,
    int minor);
 ...
 */
void mbedtls_ssl_conf_cert_profile (
    mbedtls_ssl_config* conf,
...
/* MBEDTLS_DHM_C && defined(MBEDTLS_SSL_SRV_C) */
 ...
 */
void mbedtls_ssl_conf_dhm_min_bitlen (mbedtls_ssl_config* conf, uint bitlen);
/* MBEDTLS_DHM_C && MBEDTLS_SSL_CLI_C */
...
/* MBEDTLS_SSL_FALLBACK_SCSV && MBEDTLS_SSL_CLI_C */
 ...
 */
void mbedtls_ssl_conf_cert_req_ca_list (
    mbedtls_ssl_config* conf,
 ...
 */
int mbedtls_ssl_conf_max_frag_len (mbedtls_ssl_config* conf, ubyte mfl_code);
/* MBEDTLS_SSL_MAX_FRAGMENT_LENGTH */
 ...
 */
int mbedtls_ssl_send_alert_message (
    mbedtls_ssl_context* ssl,
    ubyte level,
    ubyte message);
/**
 ...
 */
int mbedtls_ssl_tls_prf (
    const mbedtls_tls_prf_types prf,
    const(ubyte)* secret,
    size_t slen,
    const(char)* label,
    const(ubyte)* random,
