...
enum ZIP_OK = 0;
enum ZIP_EOF = 0;
enum ZIP_ERRNO = Z_ERRNO;
enum ZIP_PARAMERROR = -102;
enum ZIP_BADZIPFILE = -103;
enum ZIP_INTERNALERROR = -104;
...
enum APPEND_STATUS_CREATE = 0;
enum APPEND_STATUS_CREATEAFTER = 1;
enum APPEND_STATUS_ADDINZIP = 2;
...
int zipWriteInFileInZip (zipFile file, const(void)* buf, uint len);
/*
