...
enum ZLIB_VER_MINOR = 3;
enum ZLIB_VER_REVISION = 0;
...
alias alloc_func = void* function (voidpf opaque, uInt items, uInt size);
alias free_func = void function (voidpf opaque, voidpf address);
...
alias gzFile = gzFile_s*; /* semi-opaque gzip file descriptor */
...
int deflateInit_ (
    ...
    const(char)* version_,
    int stream_size);
int inflateInit_ (z_streamp strm, const(char)* version_, int stream_size);
int deflateInit2_ (
    z_streamp strm,
    int level,
    int method,
